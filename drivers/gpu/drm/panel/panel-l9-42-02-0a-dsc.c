...
static int l9_42_02_0a_dsc_probe(struct mipi_dsi_device *dsi)
{
	...
	drm_panel_init(&ctx->panel, dev, &l9_42_02_0a_dsc_panel_funcs,
...
static const struct of_device_id l9_42_02_0a_dsc_of_match[] = {
	{ .compatible = "mdss,l9-42-02-0a-dsc" }, // FIXME
	{ /* sentinel */ }
};
...
MODULE_DESCRIPTION("DRM driver for xiaomi 42 02 0a cmd mode dsc dsi panel");
MODULE_LICENSE("GPL");
